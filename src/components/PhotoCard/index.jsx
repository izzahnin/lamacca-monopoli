    ...
    <>
      <div className="flex flex-col w-52 sm:w-52 md:w-52 bg-gray-50 p-0 shadow-md">
        <div className="flex flex-col justify-end items-center  h-60  w-full bg-cover bg-top" style={{ backgroundImage: `url(${process.env.PUBLIC_URL + props.src})` }}>
          <div className="flex flex-col align-middle text-center border-2 rounded-full h-15 p-1 mb-2 w-48 sm:w-48 md:w-48 bg-white border-navy ">
            <p className="text-navy font-semibold text-base  sm:text-lg">{props.name}</p>
